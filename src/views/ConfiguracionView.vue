  ...
  <div class="container-fluid py-4">
    <BaseCard title="Configuración de la Empresa y Landing">
      ...
      <div class="row g-4">
        <!-- Información General -->
        <div class="col-md-6">
          <div class="p-4 border rounded bg-light h-100 shadow-none">
            ...
            <div class="mb-3">
              <label class="form-label small fw-bold text-muted text-uppercase mb-2">Dirección Física</label>
        ...
        <div class="col-md-12">
          <div class="p-4 border rounded bg-light shadow-none">
            <h6 class="fw-bold mb-4 border-bottom pb-2">
            ...
            <div class="row">
              <div class="col-md-8">
                ...
                <div class="mb-0">
                  <label class="form-label small fw-bold text-muted text-uppercase mb-2">Imagen de Fondo (Hero)</label>
                  <input type="file" @change="onFileChange($event, 'hero')" class="form-control" accept="image/*">
                  <small class="text-muted">Recomendado: 1920x1080px. Máx: 2MB.</small>
                </div>
              </div>
              <div class="col-md-4 text-center d-flex align-items-center justify-content-center">
                <div v-if="previewHero || form.hero_image_url" class="mt-2">
                  <p class="small text-muted mb-2 fw-bold text-uppercase">Vista Previa Hero</p>
                  <img :src="previewHero || form.hero_image_url" class="img-thumbnail shadow-sm border-0 bg-white p-2" style="max-height: 200px; width: 100%; object-fit: cover;">
                </div>
                <div v-else class="text-muted border rounded p-4 w-100 bg-white">
                  <i class="bi bi-image fa-3x mb-2 opacity-25"></i>
          ...
          <div class="p-4 border rounded bg-light shadow-none">
            ...
            <div class="row">
              <div class="col-md-8">
                ...
                />
                <div class="mb-3">
                  <label class="form-label small fw-bold text-muted text-uppercase mb-2">Descripción / Texto</label>
                  <textarea v-model="form.about_description" class="form-control" rows="4" placeholder="Describe tu empresa..."></textarea>
                </div>
                <div class="mb-0">
                  <label class="form-label small fw-bold text-muted text-uppercase mb-2">Imagen Lateral (Nosotros)</label>
                  <input type="file" @change="onFileChange($event, 'about')" class="form-control" accept="image/*">
                  <small class="text-muted">Recomendado: 800x600px. Máx: 2MB.</small>
                </div>
              </div>
              <div class="col-md-4 text-center d-flex align-items-center justify-content-center">
                <div v-if="previewAbout || form.about_image_url" class="mt-2">
                  <p class="small text-muted mb-2 fw-bold text-uppercase">Vista Previa Nosotros</p>
                  <img :src="previewAbout || form.about_image_url" class="img-thumbnail shadow-sm border-0 bg-white p-2" style="max-height: 200px; width: 100%; object-fit: cover;">
                </div>
                <div v-else class="text-muted border rounded p-4 w-100 bg-white">
                  <i class="bi bi-image fa-3x mb-2 opacity-25"></i>
